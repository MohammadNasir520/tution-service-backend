...
CREATE TABLE "students" (
    ...
    "academicDepartementId" TEXT NOT NULL,
    "academicFacultyId" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "students" ADD CONSTRAINT "students_academicDepartementId_fkey" FOREIGN KEY ("academicDepartementId") REFERENCES "academic_departments"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "faculties" ADD CONSTRAINT "faculties_academicDepartementId_fkey" FOREIGN KEY ("academicDepartementId") REFERENCES "academic_departments"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
